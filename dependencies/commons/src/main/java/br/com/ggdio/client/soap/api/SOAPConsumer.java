package br.com.ggdio.client.soap.api;
...
import br.com.ggdio.client.soap.invoke.Invocation;
import br.com.ggdio.client.soap.invoke.SchemaValue;
import br.com.ggdio.client.soap.model.Instance;
import br.com.ggdio.client.soap.model.Part;
import br.com.ggdio.client.soap.model.Schema;
import br.com.ggdio.client.soap.model.XSDType;
...
//	}
	...
	private void compileSoapBody(SOAPBody body, Invocation invocation) throws SOAPException {
		...
		Schema rootSchema = invocation.getOperation().getInput().getRootSchema();
		if(rootSchema != null) {
